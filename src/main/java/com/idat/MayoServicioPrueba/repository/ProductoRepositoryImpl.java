...
public class ProductoRepositoryImpl implements ProductoRepository {
	...
	public Productos obtenerProductoId(Integer id) {
		...
		//SI SE TRABAJA CON JAVA 6 O 7 PROGRAMAR EL METODO TRADICIONAL
//		if(listar !=null) {
//		
...
//		return null;
		...
		//PROGRAMAR CON FLUJOS (LANDAS) SIEMPRE Y CUANDO SEA CON JAVA VERSION 8 Y SUPERIOR
		return listar.stream().filter(p -> p.getIdProducto() == id).findFirst(). orElse(null);
		
		//solo las listas se pueden convertir a flujos, no objetos, clases ni otros.
	}
